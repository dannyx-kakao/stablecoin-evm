...
contract DeployImpl {
     ...
     * @return FiatTokenV2 newly deployed or loaded instance
     */
    function getOrDeployImpl(address impl) internal returns (FiatTokenV2) {
        FiatTokenV2 fiatTokenV2;
